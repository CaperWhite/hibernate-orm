...
class HibernateBuildPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        File secretsFile = new File("${System.properties['user.home']}/.gradle/secret.properties")

        if(secretsFile.exists()) {
            Properties secrets = new Properties()

            secretsFile.withReader { Reader reader ->
                secrets.load(reader)
            }

            secrets.each { String key, Object value ->
        ...
        if ( gradlePublishingExtension.repositories.empty ) {
            if ( project.version.endsWith( 'SNAPSHOT' ) ) {
                gradlePublishingExtension.repositories.maven {
                    ...
                    url 'https://nexus.caperwhite.com/nexus/content/repositories/snapshots/'
                ...
                gradlePublishingExtension.repositories.maven {
                    ...
                    url 'https://nexus.caperwhite.com/nexus/content/repositories/releases/'
